...
// Last update Wed Jan 16 14:22:49 2013 luca savarino
//
...
namespace functor
{
  ...
  private :
    ...
    public :
      ...
      virtual typename type<U>::_t	operator()(typename type<V>::_t) = 0;
    ...
    public :
      ...
      typename type<U>::_t		operator()(typename type<V>::_t);
  ...
  template <class U, class V>
  typename type<U>::_t		Functor<U (V)>::Function::operator()(typename type<V>::_t a)
  {
    if (_function == NULL)
  ...
  template <class U, class V>
  template <class Y>
  typename type<U>::_t			Functor<U (V)>::Object<Y>::operator()(typename type<V>::_t a)
  {
    if (_function == NULL)
  ...
  template <class U, class V>
  typename type<U>::_t			Functor<U (V)>::operator()(typename type<V>::_t a)
  {
    if (_functor == NULL)
