...
// Last update Wed Jan 16 14:22:37 2013 luca savarino
//
...
namespace functor
{
  ...
  private :
    ...
    public :
      ...
      virtual typename type<U>::_t	operator()(typename type<V>::_t, typename type<V2>::_t) = 0;
    ...
    public :
      ...
      typename type<U>::_t		operator()(typename type<V>::_t, typename type<V2>::_t);
  ...
  template <class U, class V, class V2>
  typename type<U>::_t		Functor<U (V, V2)>::Function::operator()(typename type<V>::_t a, typename type<V2>::_t b)
  {
    if (_function == NULL)
  ...
  template <class U, class V, class V2>
  template <class Y>
  typename type<U>::_t			Functor<U (V, V2)>::Object<Y>::operator()(typename type<V>::_t a, typename type<V2>::_t b)
  {
    if (_function == NULL)
  ...
  template <class U, class V, class V2>
  typename type<U>::_t			Functor<U (V, V2)>::operator()(typename type<V>::_t a, typename type<V2>::_t b)
  {
    if (_functor == NULL)
  ...
  template <class U, class V, class V2>
  bool	       	Functor<U (V, V2)>::isCallable()
  {
